  ...
  soundEffect(sfxid) {
    switch (sfxid) {
      ...
      case "dash": return this.beginSynthSound([
          { f: [400, 0.500,600], l: [0, 0.070,0.900, 0.070,0, 0.070,0.500, 0.070,0, 0.070,0.200, 0.070,0, 0.070,0.080, 0.070,0], mod: 0.5, range: [0, 0.500,3] },
        ], 0.300);
      ...
      case "pause": return this.beginSynthSound([
          { f: 1200, l: [0, 0.050,0.800, 0.050,0, 0.050,0.600, 0.050,0, 0.050,0.400, 0.050,0, 0.050,0.100, 0.050,0], mod: 2, range: 2 },
        ], 0.300);
      case "resume": return this.beginSynthSound([
          { f: [800, 0.400,400], l: [0, 0.050,0.800, 0.050,0, 0.050,0.600, 0.050,0, 0.050,0.400, 0.050,0, 0.050,0.100, 0.050,0], mod: 2, range: 2 },
        ], 0.300);
